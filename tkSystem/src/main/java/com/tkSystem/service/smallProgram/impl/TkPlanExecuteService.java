...
public class TkPlanExecuteService implements TkPlanExecuteServiceInterface {
	@Resource
	 ...
	 */
	/* (non-Javadoc)
	 * @see com.tkSystem.service.smallProgram.TkPlanExecuteServiceInterface#postTkPlanExecute(javax.servlet.http.HttpServletRequest)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.tkSystem.service.smallProgram.TkPlanExecuteServiceInterface#getTkPlanExecute(javax.servlet.http.HttpServletRequest, javax.servlet.http.HttpServletResponse)
	 */
	@Override
