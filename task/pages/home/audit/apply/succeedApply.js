// pages/home/audit/apply/succeedApply.js
var app = getApp();
Page({
  ...
  onLoad: function (options) {
    ...
    console.log(" tk_target_report_id " + tk_target_report_id);
